...
const TestimonialSection = () => {
  return (
    <div>
      <div class="h-screen w-full flex justify-center items-center dark:bg-white">
        ...
        <figure class="max-w-screen-md mx-auto">
            ...
            <figcaption class="flex items-center justify-center mt-6 space-x-3">
                ...
                <div class="flex items-center divide-x-2 ">
                    <div class="pr-3 font-medium text-black">Micheal Gough</div>
                    <div class="pl-3 text-sm font-light text-black">CEO at Google</div>
                </div>
            </figcaption>
        </figure>
    </div>
